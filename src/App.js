...
const Portfolio = () => {
  ...
  const projects = [
    { 
      ...
      deliverables: "Brand identity, rebrand materials",
      image: "/images/dw-main.png",
      description: "→ Intro\n [Democracy Works](https://www.democracy.works)is a civic tech nonprofit that helps Americans vote by partnering with election officials, major platforms, civic organizations, and companies to provide accurate data for voter access. I was tasked with working with contractors to help define our new identity and implement the organization’s marketing assets with the new brand.\n\n Web design by Haley, Ryan \nBrand design by Chris Atkins",
      research: "→ Challenge\n The challenge was combining all the tools under one website and creating a cohesive branding that would work across all the sub-brands. While each tool had a different audience, it was essential to unite them under one house name so users could trace back to the main organization behind the work: Democracy Works.",
      result: "→ Solution\n We created a reusable logomark that referenced the organization’s initials and assigned a brand color (DW Purple) with different hues that worked with a wide spectrum. This provided room for exploration when crafting marketing assets. For example, darker, more muted colors were used to hold weight for certain audience members (e.g., election officials, donors) whereas lighter colors were used for voters and partners.",
      ...
      image3: "/images/dw-03.png",
      image4: "/images/dw-05.gif",
      image5: "/images/dw-04.png",
      image6: "/images/dw-07.png",
    },
    { 
      id: 2, 
      title: "TurboVote", 
    ...
    { 
      ...
      research: "→ Challenge\n The challenge was dissecting the firm's title and old a of the numbers (50, 1), signifying a tipping point towards the majority. There was also a need to create a timeless logo symbolic of dynamic, lasting movement for and towards change.",
    ...
    { 
      ...
      year: "2024 - ongoing",
      role: "Creative director, designer, author",
      deliverables: "brand identity, essays",
      ...
      image3: "/images/schema.jpg",
      image4: "/images/schema-03.png",
    },
    {
      id: 5,
    ...
    { 
      ...
      year: "2025",
      role: "Designer",
      deliverables: "riso zine, essay, illustration",
      image: "/images/kernel-main.jpeg",
      ...
      image1: "/images/kernel-02.png",
      image2: "/images/kernel-01.png",
      image3: "/images/kernel-04.jpeg",
      image4: "/images/kernel-03.png",
    },
  ];
